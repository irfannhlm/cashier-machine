...
bg_mainimg = ImageTk.PhotoImage(pil.open(f"{filepath}/images/bg_mainimg(stylized2).png").resize((1136, 640), pil.Resampling.LANCZOS))
...
def loop1():
    ...
    try:
        if button_products.winfo_exists():
            ...
            bg1 = pil.open(f"{filepath}/images/bg_mainimg(stylized2).png")
            ...
            bg_canvas.create_text(main_window.winfo_width()/2, main_window.winfo_height() / 2 - frame_mainButtons.winfo_height(), 
                                  font=("Oretans Shadow", 80), text="STEI-MART!", fill="#faf796")
    ...
    try:
        if button_print.winfo_exists():
            ...
            bg_canvas.create_text(main_window.winfo_width() / 2, main_window.winfo_height() / 2 - frame_endButtons.winfo_height() / 1.2, 
                                  font=("Oretans Shadow", 50), text="Terima Kasih Telah Berbelanja!", fill="#faf796")
...
def hitung_kembalian():
    global harga_produk, harga_total, jumlah_produk, lembaran_kembalian, count_hitung, frame_lembaran
...
def window_selesai():
    global button_exit, button_info, button_help, label_clock, frame_endButtons, loopcount
...
def save_receipt():
    receiptpath = filedialog.asksaveasfile(initialdir=f"{filepath}/receipt/", initialfile=f"{fname}.txt", defaultextension=".txt",
