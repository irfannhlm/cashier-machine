...
"""
        ...
        bgcanvas_info.create_text(568/2, 20, font=("Maiandra GD", 15), width=568, text="Program Model Kasir Supermarket v1.0", justify=CENTER)
...
def window_harga():
    ...
    label_hargaProduk = Label(frame_hargaProduk, font=("Courier New", 30), textvariable=tampil_hargaProduk, width=11,
                              bg="black", fg="white", relief=SUNKEN, anchor=CENTER, padx=7, pady=7)
    label_x = Label(frame_hargaProduk, font=("Courier New", 30), text="x", width=1, bg="#b3b5c7")
    label_jumlahProduk = Label(frame_hargaProduk, font=("Courier New", 30), textvariable=tampil_jumlahProduk, bg="black",
                               fg="white", width=3, relief=SUNKEN, anchor=CENTER, padx=7, pady=7)
    ...
    label_judulConsole = Label(frame_console, font=("Courier New", 30), text="Console:", bg="black", fg="white",
                               anchor=CENTER, relief=SUNKEN)
    label_subTotal = Label(frame_console, font=("Courier New", 14), textvariable=tampil_subTotal, bg="black", fg="white",
...
def hitung_harga():
    ...
    if kode_produk[entry_kodeProduk.get()].kuantitas >= int(jumlah_produk):
        ...
        Label(bgframe2_console, font=("Courier New", 12), text=f"{kode_produk[entry_kodeProduk.get()].nama}   "
...
def window_kembalian():
    ...
    if harga_total != 0:
        ...
        label_judulTunai = Label(frame_tunai, font=("Courier New", 15), text="Uang Tunai:", anchor=W, bg="black",
                                fg="white", relief=GROOVE, padx=7, pady=7)
        label_tunai = Label(frame_tunai, font=("Courier New", 30), textvariable=tampil_tunai, width=15,
                            bg="black", fg="white", relief=GROOVE, anchor=CENTER)
        label_min = Label(frame_tampilTunai, font=("Courier New", 30), text="-", width=1, anchor=S, bg="#b3b5c7")
        frame_harga = Frame(frame_tampilTunai, bg="#b3b5c7")
        label_judulHarga = Label(frame_harga, font=("Courier New", 15), text="Harga Total:", anchor=W, bg="black",
                                fg="white", relief=GROOVE, padx=7, pady=7)
        label_hargaTotal = Label(frame_harga, font=("Courier New", 30), text=f"Rp{harga_total:,.02f}", width=15,
                                bg="black", fg="white", relief=GROOVE, anchor=CENTER)
